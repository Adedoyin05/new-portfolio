        ...
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
          <div className="flex flex-col justify-center h-full">
            ...
            {/* <p className="text-gray-500 py-4 max-w-md">
              hhhghvdhhvdgvxhgdjvuxghvbhguvbjcgugvdbjvg cj cjbbbbbbbbjbbbvbvvv
              hhbhvhgygug7ugjhjhuhihihihihhhhhhhhhhhhhhhhhh
            </p> */}
          ...
          <div>
            <img
              src={HeroImage}
              alt="my profile"
              className="rounded-2xl mx-auto w-84 h-64 md:w-full"
            />
          </div>
        </div>
      </div>
