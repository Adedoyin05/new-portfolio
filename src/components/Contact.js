...
const Contact = () => {
  return (
    <div name="contact" id='Contact' className='w-full h-screeen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
      ...
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
            <form action='https://getform.io/f/1e8cb2a2-21ac-4952-bca7-7abfbd22e972' method='POST' className='flex flex-col w-full md:w-1/2'>
